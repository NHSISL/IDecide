...
namespace LondonDataServices.IDecide.Core.Brokers.Securities
{
    ...
    internal interface ISecurityAuditBroker
    {
        ...
        /// <param name="claimsPrincipal">The user's claims principal for extracting identity information.</param>
        /// <param name="securityConfigurations">The audit configuration specifying property names and types.</param>
