...
namespace LondonDataServices.IDecide.Core.Brokers.Securities
{
    ...
    internal class SecurityBroker : ISecurityBroker
    {
        ...
        public async ValueTask<bool> HasClaimTypeAsync(string claimType, string claimValue) =>
            await this.securityClient.Users.UserHasClaimTypeAsync(this.claimsPrincipal, claimType, claimValue);
        ...
        public async ValueTask<bool> HasClaimTypeAsync(string claimType) =>
            await this.securityClient.Users.UserHasClaimTypeAsync(this.claimsPrincipal, claimType);
        ...
        public async ValueTask<bool> IsCurrentUserAuthenticatedAsync() =>
            await this.securityClient.Users.IsUserAuthenticatedAsync(this.claimsPrincipal);
        ...
        public async ValueTask<bool> IsInRoleAsync(string roleName) =>
            await this.securityClient.Users.IsUserInRoleAsync(this.claimsPrincipal, roleName);
        ...
        {
            var currentUserFromClaimsPrincipal =
                await this.securityClient.Users.GetUserAsync(this.claimsPrincipal);

            return new User(
                userId: currentUserFromClaimsPrincipal.UserId,
                givenName: currentUserFromClaimsPrincipal.GivenName,
                surname: currentUserFromClaimsPrincipal.Surname,
                displayName: currentUserFromClaimsPrincipal.DisplayName,
                email: currentUserFromClaimsPrincipal.Email,
                jobTitle: currentUserFromClaimsPrincipal.JobTitle,
                roles: currentUserFromClaimsPrincipal.Roles,
                claims: currentUserFromClaimsPrincipal.Claims);
        }
