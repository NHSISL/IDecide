...
namespace StandardlyTestProject.Api.Services.Foundations.DecisionTypes
{
    ...
    {
        private static (dynamic Rule, string Parameter)[] GetSharedValidationsRules(DecisionType decisionType)
        {
            (dynamic Rule, string Parameter)[] sharedValidationRules = [
        ...
        private async ValueTask ValidateDecisionTypeOnAdd(DecisionType decisionType)
        {
            ...
            var sharedValidations = GetSharedValidationsRules(decisionType);

            var allValidations = sharedValidations.Concat(
            [
                (Rule: IsNotSame(
