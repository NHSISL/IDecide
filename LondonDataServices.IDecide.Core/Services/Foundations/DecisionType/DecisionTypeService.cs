...
namespace LondonDataServices.IDecide.Core.Services.Foundations.DecisionType
{
    public partial class DecisionTypeService : IDecisionTypeService
    {
        ...
        public ValueTask<IQueryable<DecisionType>> RetrieveAllDecisionTypeAsync() =>
            TryCatch(async () => await this.storageBroker.SelectAllDecisionTypeAsync());
        ...
        public ValueTask<DecisionType> ModifyDecisionTypeAsync(DecisionType decisionType) =>
            TryCatch(async () =>
            {
                decisionType = await this.securityAuditBroker.ApplyModifyAuditValuesAsync(decisionType);
