...
namespace LondonDataServices.IDecide.Manage.Server.Tests.Acceptance.Brokers
{
    public partial class ApiBroker
    {
        ...
        public async ValueTask<List<ConsumerAdoption>> GetSpecificConsumerAdoptionByIdAsync(Guid consumerAdoptionId) =>
            await this.apiFactoryClient.GetContentAsync<List<ConsumerAdoption>>(
                $"{consumerAdoptionsRelativeUrl}?$filter=Id eq {consumerAdoptionId}");

        public async ValueTask<ConsumerAdoption> GetConsumerAdoptionByIdAsync(Guid consumerAdoptionId) =>
            await this.apiFactoryClient
                .GetContentAsync<ConsumerAdoption>($"{consumerAdoptionsRelativeUrl}/{consumerAdoptionId}");

        public async ValueTask<ConsumerAdoption> DeleteConsumerAdoptionByIdAsync(Guid consumerAdoptionId) =>
            await this.apiFactoryClient
                .DeleteContentAsync<ConsumerAdoption>($"{consumerAdoptionsRelativeUrl}/{consumerAdoptionId}");
