                    ...
                    <Col md={10} lg={8}>
                        <Card>
                            <Card.Body>
                                ...
                                <h2 className="h5 mt-4">NHS Login</h2>
                                <p>
                                    If you access our service using NHS England services (such as NHS login), please note the following:
                                </p>
                                <p>
                                    Please note that if you access our service using your NHS login details, the identity verification services are managed by NHS England. NHS England is the controller for any personal information you provided to NHS England to get an NHS login account and verify your identity, and uses that personal information solely for that single purpose. For this personal information, our role is a “processor” only and we must act under the instructions provided by NHS England (as the “controller”) when verifying your identity. To see NHS login’s Privacy Notice and Terms and Conditions, please <a href="https://www.nhs.uk/nhs-services/online-services/nhs-login/privacy-notice/" target="_blank" rel="noopener noreferrer">click here</a>. This restriction does not apply to the personal information you provide to us separately.
                                </p>
                            </Card.Body>
                        </Card>
                    </Col>
