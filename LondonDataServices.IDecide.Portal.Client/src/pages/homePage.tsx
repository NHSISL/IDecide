...
const expandableContent = [
    ...
    [
        <p key="p1">
            ...
            To registering your details to 'opt-out' click the start button below.
        </p>,
        <p key="p2">
            ...
            To do that please e-mail <a href="mailto:NELondonicb.oneLondon.opt-out@nhs.net">NELondonicb.oneLondon.opt-out@nhs.net</a> make the subject of the e-mail Dissent from data sharing for direct care.
        </p>
    ],
        ...
        <div className="fullscreen-bg">
            <div className="fullscreen-bg-overlay">
                <div className="home-box">
                    ...
                    <p>
                        <strong>Click on the Start button below to tell us your data preference
                        </strong>
                    </p>
