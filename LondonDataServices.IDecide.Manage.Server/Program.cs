    ...
    public class Program
    {
        ...
        private static void AddProviders(IServiceCollection services, IConfiguration configuration)
        {
            ...
            else
            {
                GoogleReCaptchaConfigurations reCaptchaConfigurations =
                    configuration.GetSection("googleReCaptchaConfigurations").Get<GoogleReCaptchaConfigurations>();
        ...
        private static void AddBrokers(IServiceCollection services, IConfiguration configuration)
        {
            ...
            SecurityBrokerConfigurations securityBrokerConfigurations =
                configuration.GetSection("SecurityBrokerConfigurations").Get<SecurityBrokerConfigurations>();
