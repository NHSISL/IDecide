...
namespace LondonDataServices.IDecide.Core.Tests.Unit.Services.Foundations.Notifications
{
    public partial class NotificationServiceTests
    {
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnSendCodeNotificationIfEmailAndInvalidEmailAndLogItAsync(
            string invalidText)
        {
            // given
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnSendCodeNotificationIfPhoneAndInvalidPhoneAndLogItAsync(
            string invalidText)
        {
            // given
            NotificationInfo randomNotificationInfo = CreateRandomNotificationInfo();
        ...
        [InlineData("")]
        [InlineData(" ")]
        public async Task ShouldThrowValidationExceptionOnSendCodeNotificationIfLetterAndInvalidAddressAndLogItAsync(
            string invalidText)
        {
            // given
            NotificationInfo randomNotificationInfo = CreateRandomNotificationInfo();
