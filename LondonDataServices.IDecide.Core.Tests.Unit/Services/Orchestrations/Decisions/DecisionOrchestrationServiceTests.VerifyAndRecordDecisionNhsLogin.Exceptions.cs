...
namespace LondonDataServices.IDecide.Core.Tests.Unit.Services.Orchestrations.Decisions
{
    public partial class DecisionOrchestrationServiceTests
    {
        ...
        public async Task ShouldThrowDependencyValidationOnVerifyAndRecordDecisionNhsLoginAndLogItAsync(
            Xeption dependencyValidationException)
        {
            ...
            ValueTask verifyAndRecordDecisionTask =
                this.decisionOrchestrationService.VerifyAndRecordDecisionNhsLoginAsync(inputDecision);
        ...
        public async Task ShouldThrowDependencyOnVerifyAndRecordDecisionNhsLoginAndLogItAsync(
        ...
        [Fact]
        public async Task ShouldThrowServiceExceptionOnVerifyAndRecordDecisionNhsLoginIfServiceErrorOccurredAndLogItAsync()
        {
            // given
            string randomNhsNumber = GenerateRandom10DigitNumber();
            string randomValidationCode = GetRandomStringWithLengthOf(5);
