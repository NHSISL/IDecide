...
namespace LondonDataServices.IDecide.Core.Tests.Unit.Services.Orchestrations.Decisions
{
    ...
    {
        [Fact]
        public async Task ShouldThrowValidationExceptionOnVerifyAndRecordDecisionNhsLoginAsyncWithNullDecision()
        {
            // given
            ...
            ValueTask verifyAndRecordDecisionTask =
               this.decisionOrchestrationService
                   .VerifyAndRecordDecisionNhsLoginAsync(nullDecision);
        ...
        [Fact]
        public async Task ShouldThrowValidationExceptionOnVerifyAndRecordDecisionNhsLoginAsyncWithNullDecisionPatient()
        {
            // given
            ...
            ValueTask verifyAndRecordDecisionTask =
               this.decisionOrchestrationService
                   .VerifyAndRecordDecisionNhsLoginAsync(randomDecision);
        ...
        public async Task ShouldThrowValidationExceptionOnVerifyAndRecordDecisionNhsLoginAsyncWithInvalidNhsNumber(
